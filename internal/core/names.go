...
var genericChannelLabels = map[string]string{
	...
	// zenpower (AMD SVI2 telemetry); confirmed against a real Ryzen
	// 3900X's `sensors` output, not guessed.
	"SVI2_Core":   "CPU Core Voltage",
	"SVI2_SoC":    "CPU SoC Voltage",
	"SVI2_C_Core": "CPU Core Current",
	"SVI2_C_SoC":  "CPU SoC Current",
	"SVI2_P_Core": "CPU Core Power (SVI2)",
	"SVI2_P_SoC":  "CPU SoC Power (SVI2)",
